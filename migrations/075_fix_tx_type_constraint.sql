-- Migration 075: Re-apply tx_type constraint (atomic DO block for PgBouncer safety)
-- This is the canonical, complete list of all valid tx_types.
-- Using DO block so DROP+ADD execute as a single statement through PgBouncer.
DO $$
BEGIN
