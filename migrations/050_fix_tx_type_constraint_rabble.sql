-- Migration 050: Fix credit_ledger tx_type constraint for Rabble creature types
-- Migrations 042 and 045 used DO $$ blocks which silently fail on PgBouncer.
-- This plain ALTER TABLE will actually apply.
