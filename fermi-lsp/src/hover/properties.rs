...
pub fn get_property_hover(word: &str) -> Option<String> {
    let text = match word {
        ...
        "confidence_threshold" => "**confidence_threshold** - Minimum confidence level\n\nMinimum confidence score (0.0-1.0) required to accept agent output.\n\n**Format:** Probability value between 0.0 and 1.0\n\n**Example:**\n```fpl\nagent market_research {\n    type: \"research\"\n    query: \"AMD market trends\"\n    confidence_threshold: 0.75\n}\n```\n\n**Used in:** agent blocks\n\n**Purpose:** Quality control - only accept high-confidence agent results\n\n**Interpretation:**\n- 0.9+ = Very high confidence required\n- 0.7-0.9 = High confidence\n- 0.5-0.7 = Moderate confidence\n- <0.5 = Low confidence acceptable",
