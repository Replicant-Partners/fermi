...
### Zone 1: Configuration (Layer 1 — collapsible)

Settings the user applies to the creature. Shown as a card that can be collapsed once configured.

| Element | Type | Notes |
|---------|------|-------|
| Name / Rename | Inline edit | Tap to edit |
| Presence toggle | Segmented control | Active / Sleeping / Parked |
| Paired devices | List + add button | AirTag, SmartTag, etc. |
| Activate Wings | Toggle | Physics sim on/off |
| SOSA opt-in | Toggle | Location data consent |
| Share / Visibility | Selector | Public / Shared / Private |
| Set as avatar | Button | Use image as profile pic |

### Zone 2: Actions (Layer 2 — always visible, primary)

The core interaction buttons. These are what the creature **does**. Always visible, prominently placed.
...
### Zone 3: Activity (Layer 3 — scrollable report)

Views on what the creature has done and is doing. Drill-down into detail.

| Element | Type | Content |
|---------|------|---------|
| Active flight banner | Status card | Current location, duration, "End Flight" button |
| Flight Log | Expandable list | Recent + historical, tap for telemetry |
| Rabble participation | List | Rabbles joined/hosted, tap to open |
| Activity sparkline | Chart | 30-day flight frequency |
| Data Card | Collapsible | Species info, creation date, stats |
| Description | Collapsible | Variation notes, 2-line preview |

### Current vs Proposed Layout

```
CURRENT (mixed layers):          PROPOSED (three zones):
┌─────────────────────┐          ┌─────────────────────┐
│ Image               │          │ Image               │
│ Name + Stats        │          │ Name + Stats        │
│ Share / Invite      │          ├─────────────────────┤
│ [Teleport] [Join]   │          │ ZONE 2: ACTIONS     │
│ [Host]    [Plan]    │          │ [Teleport] [Join]   │
│ [Gift]              │          │ [Host]    [Plan]    │
│ [Activate Wings]    │          │ [Invite]  [Gift]    │
│ Description (mixed) │          ├─────────────────────┤
│ Data Card           │          │ ZONE 3: ACTIVITY    │
│ Visibility          │          │ Active flight banner│
│ Flight Log          │          │ Flight Log          │
│ (config and reports │          │ Rabble history      │
│  interleaved)       │          │ Activity sparkline  │
└─────────────────────┘          ├─────────────────────┤
                                 │ ZONE 1: CONFIG (v)  │
                                 │ Presence, Devices,  │
                                 │ Wings, SOSA, Share  │
...
Config is at the bottom and collapsed by default because you set it once and forget it. Actions are front and center because they're what you came here to do. Activity is the report of what's happened.
