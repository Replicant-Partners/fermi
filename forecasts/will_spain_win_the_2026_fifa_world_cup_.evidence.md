...
**Probability:** 55.9% · **Version:** v3 · **Updated:** 2026-07-16 23:30 UTC
...
Of 23 World Cups held through 2022, European teams won 12 (Italy 4, Germany 4, Spain 1, England 1, France 2). This gives a 52% base rate for European winners. Spain specifically has won 1 of 23 tournaments (4.3%), but as a top-tier European side with recent success (2010 winner, 2022 runner-up), the broader European elite reference class is more appropriate than Spain's individual frequency. Among the ~8 European teams typically considered contenders (Germany, France, Spain, Italy, England, Netherlands, Portugal, Belgium), the per-tournament win rate is approximately 12/184 team-tournaments ≈ 6.5%. Using Spain's tier (top-4 European side based on current FIFA ranking #3 and recent performance) suggests a starting base rate of 6-8% for a specific elite European contender.
...
|---|---|---|---|---|---|---|---|
| v1 | 2026-07-16 23:30 | 55.9% | 52.0% | 58.4% | +3.9pp | -2.5pp | Initial: 55.9% base=52%, 6 drivers, 4 evidence |
| v2 | 2026-07-16 23:30 | 55.9% | 52.0% | 58.4% | +3.9pp | -2.5pp | 55.9% (→), 6 drivers, 4 evidence, 1 agents |
| v3 | 2026-07-16 23:30 | 55.9% | 52.0% | 58.4% | +3.9pp | -2.5pp | 55.9% (→), 6 drivers, 4 evidence, 1 agents |
...
_Generated by [Fermi Console](https://agent-bestiary.world) · v3 · 2026-07-16 23:30 UTC_
