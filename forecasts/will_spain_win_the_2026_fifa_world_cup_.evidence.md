...
**Probability:** 11.9% · **Version:** v1 · **Updated:** 2026-07-03 12:28 UTC
...
| Crowd price | **13.4%** |
| Fermi estimate | **11.9%** |
| Divergence | +1.4pp below crowd (Consensus) |
| 24h volume | $2.6M |
...
Inside view: model evaluates to 11.9% (p5=8.9%, p95=15.6%). Outside view (base rate): 2.1%. Key drivers: socio_capital, institutional_capacity, dynamic_performance.

**Forecast Confidence:** Medium (50%)

**Divergence from base rate:** 10pp above (11.9% vs 2.1%)
...
**10000 iterations** · p5 = 8.9% · median = 11.7% · p95 = 15.6% · σ = 0.020
