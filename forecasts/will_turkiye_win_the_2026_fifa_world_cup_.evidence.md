...
**Probability:** 4.0% · **Version:** v4 · **Updated:** 2026-06-22 12:40 UTC
...
Inside view: model evaluates to 4.0% (p5=2.8%, p95=5.5%). Outside view (base rate): 2.1%. Key drivers: socio_capital, institutional_capacity, dynamic_performance.
...
**10000 iterations** · p5 = 2.8% · median = 4.0% · p95 = 5.5% · σ = 0.009
...
|---|---|---|---|---|---|---|---|
| v1 | 2026-06-22 12:40 | 4.0% | 2.1% | 0.4% | +2.0pp | +3.6pp | Initial: 4.0% base=2%, 6 drivers, 4 evidence |
| v2 | 2026-06-22 12:40 | 4.0% | 2.1% | 0.4% | +2.0pp | +3.6pp | 4.0% (→), 6 drivers, 4 evidence |
| v3 | 2026-06-22 12:40 | 4.0% | 2.1% | 0.4% | +2.0pp | +3.6pp | 4.0% (→), 6 drivers, 4 evidence |
| v4 | 2026-06-22 12:40 | 4.0% | 2.1% | 0.4% | +2.0pp | +3.6pp | 4.0% (→), 6 drivers, 4 evidence |

**Model line:** ```███▁``` (range 4.0% – 4.0%)
...
_Generated by [Fermi Console](https://agent-bestiary.world) · v4 · 2026-06-22 12:40 UTC_
